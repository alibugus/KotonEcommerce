...
namespace EcommerceProject.Migrations
{
    ...
    [Migration("20240815115838_guestorder")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceProject.Models.CouponModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "WELCOME10",
                            DiscountAmount = 10m,
                            ExpiryDate = new DateTime(2024, 9, 15, 14, 58, 36, 827, DateTimeKind.Local).AddTicks(7097),
                            IsActive = true
                        },
                        new
                        {
                            ...
                            Code = "SUMMER20",
                            DiscountAmount = 20m,
                            ExpiryDate = new DateTime(2024, 10, 15, 14, 58, 36, 827, DateTimeKind.Local).AddTicks(7184),
                            IsActive = true
                        },
                        new
                        {
                            ...
                            Code = "FALL30",
                            DiscountAmount = 30m,
                            ExpiryDate = new DateTime(2024, 11, 15, 14, 58, 36, 827, DateTimeKind.Local).AddTicks(7186),
                            IsActive = true
                        });
                });
            ...
            modelBuilder.Entity("EcommerceProject.Models.OrderDetailModel", b =>
                {
                    ...
                    b.Property<int?>("GuestOrderModelId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommerceProject.Models.OrderDetailModel", b =>
                {
                    b.HasOne("EcommerceProject.Models.GuestOrderModel", null)
                        .WithMany("OrderDetails")
                        .HasForeignKey("GuestOrderModelId");
